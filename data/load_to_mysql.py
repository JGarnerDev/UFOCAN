...
ufos_northwest_territories = ufos_canada[ufos_canada['Province'] == 'Northwest Territories']
ufos_ontario = ufos_canada[ufos_canada['Province'] == 'Ontario']
ufos_british_columbia = ufos_canada[ufos_canada['Province'] == 'British Columbia']
...
ufos_newfoundland = ufos_canada[ufos_canada['Province'] == 'Newfoundland and Labrador']
...
ufos_prince_edward_island = ufos_canada[ufos_canada['Province'] == 'Prince Edward Island']
...
for table in table_list:
    table[0].to_sql(table[1], con=engine,
